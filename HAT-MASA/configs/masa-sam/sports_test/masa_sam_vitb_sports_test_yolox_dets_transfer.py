_base_ = [
    '../sam-vitb.py',
    '../../datasets/sportsmot/sportsmot_dataset_test.py',
    '../../default_runtime.py'
]
default_scope = 'mmdet'
...
model = dict(
    ...
    benchmark = 'sportsmot_test',
    public_det_path = 'results/public_dets/sports_test_detections/',
...
val_dataloader = dict(
    dataset=dict(
        ann_file='data/sportsmot/annotations/test.json',
...
test_evaluator = dict(
    ann_file='data/sportsmot/annotations/test.json',
outfile_prefix='results/masa_results/sports_masa-groundingdino-release_detic_dets-test',
)
