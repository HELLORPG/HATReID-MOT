_base_ = [
    ...
    '../../datasets/mot17/mot17_dataset.py',
    '../../default_runtime.py'
]
default_scope = 'mmdet'
...
model = dict(
    ...
    benchmark='mot17_half',
    # benchmark = 'mot17',
    public_det_path='results/public_dets/mot17_half_detections/',
    # public_det_path = 'results/public_dets/mot17_detections/',
    ...
    tracker=dict(
        ...
        transfer_hist_len=40,
        transfer_factor_thr=5.0,
        )
)
...
val_dataloader = dict(
    dataset=dict(
        ann_file='data/mot/annotations/val_half.json',
        # ann_file='data/mot/annotations/test.json',
    )
)
test_dataloader = val_dataloader
val_evaluator = dict(
    ann_file='data/mot/annotations/val_half.json',
outfile_prefix='results/masa_results/mot17_half_masa-groundingdino-release_detic_dets-test',
#     ann_file='data/mot/annotations/test.json',
# outfile_prefix='results/masa_results/mot17_masa-groundingdino-release_detic_dets-test',
)
