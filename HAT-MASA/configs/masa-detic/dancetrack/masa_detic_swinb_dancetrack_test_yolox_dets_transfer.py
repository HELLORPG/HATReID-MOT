_base_ = [
    ...
    '../../datasets/dancetrack/dancetrack_dataset_test.py',
    '../../default_runtime.py'
]
default_scope = 'mmdet'
...
model = dict(
    ...
    benchmark='dancetrack_test',
    public_det_path='results/public_dets/dance_test_detections/',
    ...
    tracker=dict(
        ...
        transfer_hist_len=60,
        transfer_factor_thr=4.0,
        transfer_similarity_alpha=0.5,
    )
)
...
val_dataloader = dict(
    dataset=dict(
        ann_file='data/dancetrack/annotations/test.json',
    )
)
test_dataloader = val_dataloader
val_evaluator = dict(
    ann_file='data/dancetrack/annotations/test.json',
    outfile_prefix='results/masa_results/dance_masa-detic-release_detic_dets-test',
)
