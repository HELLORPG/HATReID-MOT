_base_ = [
    ...
    '../../datasets/dancetrack/dancetrack_dataset_val.py',
    '../../default_runtime.py'
]
default_scope = 'mmdet'
...
model = dict(
    ...
    public_det_path='results/public_dets/dance_detections/',
...
val_dataloader = dict(
    dataset=dict(
        ann_file='data/dancetrack/annotations/val.json',
    )
)
test_dataloader = val_dataloader
val_evaluator = dict(
    ann_file='data/dancetrack/annotations/val.json',
    outfile_prefix='results/masa_results/dance_masa-groundingdino-release_detic_dets-test',
)
