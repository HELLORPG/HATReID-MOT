...
try:
    ...
    if not os.path.exists(os.path.join(download_dir, "taggers/averaged_perceptron_tagger")):
        nltk.download("averaged_perceptron_tagger", download_dir=download_dir, quiet=False)
except ImportError:
    raise RuntimeError(
