...
class DanceMetric(BaseVideoMetric):
    ...
    def evaluate(self, size: int = 1) -> dict:
        ...
        if is_main_process():
            ...
            result_files_path = f"{self.outfile_prefix}/dance_track.json"
        ...
        # ============================================================================
            self.dance_evaluation(all_seq_pred_json)
    ...
    # ============================================================================
    def dance_evaluation(self, all_seq_pred_json):
        print("############################ Evaluation ############################")
        print(f"Start evaluation")

        # Annotation path:
        data_path = "data/dancetrack/annotations/val.json"
        # Outputs path:
        output_dir = f"{self.outfile_prefix}/dance_tracking_results"
        ...
        command = [
            ...
            '--SEQMAP_FILE', 'TrackEval/data/gt/seqmaps/DanceTrack-val.txt',
            '--SKIP_SPLIT_FOL', 'True',
            '--TRACKERS_TO_EVAL', '',
            '--TRACKER_SUB_FOLDER', '',
            '--USE_PARALLEL', 'True',
            ...
            '--PLOT_CURVES', 'False',
            '--TRACKERS_FOLDER',
            'results/masa_results/dance_masa-groundingdino-release_detic_dets-test/dance_tracking_results'
        ]
