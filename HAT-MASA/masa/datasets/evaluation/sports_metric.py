...
class SportsMetric(BaseVideoMetric):
    ...
    def evaluate(self, size: int = 1) -> dict:
        ...
        if is_main_process():
            ...
            result_files_path = f"{self.outfile_prefix}/sports_track.json"
        ...
        # ============================================================================
            self.sports_evaluation(all_seq_pred_json)
        ...
        # Hack implementation, we do not evaluate in the MMDetection.
        barrier()
    ...
    # ============================================================================
    def sports_evaluation(self, all_seq_pred_json):
        print("############################ Evaluation ############################")
        print(f"Start evaluation")

        # Annotation path:
        data_path = "data/sportsmot/annotations/val.json"
        # Outputs path:
        output_dir = f"{self.outfile_prefix}/sports_tracking_results"
        # MASA tracking results:
        tracking_data = all_seq_pred_json
        print(f"{len(tracking_data)} datas in total.")
        ...
        # Convert results of each sequence to txt format:
        for video_id in video_id_to_name:
            # Current video's tracking data
            ...
            with open(filepath, 'w') as f:
                for entry in video_data:
                    ...
                    # from image_id to frame_id:
                    frame_id = id_to_frame_id.get(image_id, -1)
        ...
        command = [
            ...
            '--GT_FOLDER', 'data/sportsmot/val',
            '--SEQMAP_FILE', 'data/sportsmot/val_seqmap.txt',
            '--SKIP_SPLIT_FOL', 'True',
            '--TRACKERS_TO_EVAL', '',
            '--TRACKER_SUB_FOLDER', '',
            '--USE_PARALLEL', 'True',
            ...
            '--PLOT_CURVES', 'False',
            '--TRACKERS_FOLDER',
            'results/masa_results/sports_masa-groundingdino-release_detic_dets-test/sports_tracking_results'
        ]
