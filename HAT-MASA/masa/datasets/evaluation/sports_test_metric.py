...
class SportsTestMetric(BaseVideoMetric):
    ...
    def sports_evaluation(self, all_seq_pred_json):
        ...
        # Annotation path:
        data_path = "data/sportsmot/annotations/test.json"
        # Outputs path:
        ...
        print("You should submit the saved tracking results to the evaluation server.")
